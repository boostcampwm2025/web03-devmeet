import {
  cardItemAssetKeyNameVo,
  cardItemAssetMimeTypeVo,
  CardItemAssetProps,
  cardItemAssetSizeVo,
...
export class CardItemAsset {
  ...
  getItemId(): CardItemAssetProps['item_id'] {
    return this.item_id;
  }
  getKeyName(): CardItemAssetProps['key_name'] {
    return this.key_name;
  }
  getMimeType(): CardItemAssetProps['mime_type'] {
    return this.mime_type;
  }
  getSize(): CardItemAssetProps['size'] {
    return this.size;
  }
  ...
  getUpadetedAt(): Exclude<CardItemAssetProps['updated_at'], undefined> {
