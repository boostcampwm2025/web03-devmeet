...
export class CardLike {
  ...
  constructor({
    id, card_id, user_id, created_at = new Date()
  } : CardLikeProps) {
    this.id = idVo(id);
  ...
  getId() : CardLikeProps["id"] { return this.id; };
  getCardId() : CardLikeProps["card_id"] { return this.card_id; };
  getUserId() : CardLikeProps["user_id"] { return this.user_id; };
  getCreatedAt() : Exclude<CardLikeProps["created_at"], undefined> { return this.created_at; };
