...
export class CardState {
  ...
  getId(): CardStateProps['id'] {
    return this.id;
  }
  getCardId(): CardStateProps['card_id'] {
    return this.card_id;
  }
  getLikeCount(): CardStateProps['like_count'] {
    return this.like_count;
  }
  getViewCount(): CardStateProps['view_count'] {
    return this.view_count;
  }
  getCreatedAt(): Exclude<CardStateProps['created_at'], undefined> {
    return this.created_at;
  }
  getUpdatedAt(): Exclude<CardStateProps['updated_at'], undefined> {
