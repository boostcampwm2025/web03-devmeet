...
export class Room {
  ...
  constructor({
    room_id, code, title, password_hash = undefined, owner_user_id, max_participants, status, created_at = new Date(), updated_at = new Date(), deleted_at = undefined
  } : RoomProps) {
  ...
  getCode() : RoomProps["code"] { return this.code; };
  getTitle() : RoomProps["title"] { return this.title; };
  getPasswordHash() : Exclude<RoomProps["password_hash"], undefined> { return this.password_hash; };
  getOwnerUserId() : RoomProps["owner_user_id"] { return this.owner_user_id; };
  getMaxParticipants() : RoomProps["max_participants"] { return this.max_participants; };
  getStatus() : RoomProps["status"] { return this.status; };
  getCreatedAt() : Exclude<RoomProps["created_at"], undefined> { return this.created_at; };
  getUpdatedAt() : Exclude<RoomProps["updated_at"], undefined> { return this.updated_at; };
  getDeletedAt() : Exclude<RoomProps["deleted_at"], undefined> { return this.deleted_at; };
